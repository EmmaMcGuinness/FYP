...
public class Graph2 extends Fragment {
    ...
    private void getPropAndVariety() {
        databaseReference.child("Blocks").child(String.valueOf(2)).addValueEventListener(new ValueEventListener() {
            @Override
    ...
    private void getBlocksGDHDates() {
        ...
        getGDH.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot : snapshot.child("GDH").child(String.valueOf(2)).getChildren()) {
                ...
                LineDataSet dataSet1 = new LineDataSet(gdhData1, "Block 2 GDH");
