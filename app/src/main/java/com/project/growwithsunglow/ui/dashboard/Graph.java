...
public class Graph extends Fragment {
    ...
    private void getPropAndVariety() {
        databaseReference.child("Blocks").child(String.valueOf(1)).addValueEventListener(new ValueEventListener() {
            @Override
    ...
    private void getBlocksGDHDates() {
        ...
        getGDH.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot : snapshot.child("GDH").child(String.valueOf(1)).getChildren()) {
